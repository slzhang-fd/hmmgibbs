...
tmp <- b_tp[1] + d_tp * u_tp_fp[,1]
lambda_1_tp <- 1 / (1+exp(-tmp))
tmp <- b_fp[1] + d_fp * u_tp_fp[,2]
...
tmp <- b_tp[2] + beta_tp[1] * C_1_tp + beta_tp[2] * C_1_fp + u_tp_fp[,1]
lambda_2_tp <- 1 / (1 + exp(-tmp))
tmp <- b_fp[2] + beta_fp[1] * C_1_fp + beta_fp[2] * C_1_tp + u_tp_fp[,2]
...
tmp <- b_tp[3] + beta_tp[1] * C_2_tp + beta_tp[2] * C_2_fp + u_tp_fp[,1]
lambda_3_tp <- 1 / (1 + exp(-tmp))
tmp <- b_fp[3] + beta_fp[1] * C_2_fp + beta_fp[2] * C_2_tp + u_tp_fp[,2]
